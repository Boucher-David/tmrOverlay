...
- Keeps compact edge-case telemetry, model-v2 parity, live-overlay diagnostics, post-race analysis, and localhost browser-source diagnostics enabled by default while raw capture remains opt-in; the Support tab shows their status as advanced collection tools.
