...
internal sealed class SettingsOverlayForm : PersistentOverlayForm
{
    ...
    private void AddWindowsBuildCommands(TabPage page)
    {
        ...
        var cleanBuildLabel = CreateLabel("Clean+Build", 22, 270, 70);
        var cleanBuildCommand = CreateCommandTextBox(92, 266, 350, WindowsCleanBuildCommand);
        var cleanBuildCopy = CreateCopyButton(452, 266, WindowsCleanBuildCommand);
        var buildLabel = CreateLabel("Build", 22, 316, 70);
        var buildCommand = CreateCommandTextBox(92, 312, 350, WindowsBuildCommand);
        var buildCopy = CreateCopyButton(452, 312, WindowsBuildCommand);
        ...
        page.Controls.Add(cleanBuildLabel);
        page.Controls.Add(cleanBuildCommand);
        page.Controls.Add(cleanBuildCopy);
