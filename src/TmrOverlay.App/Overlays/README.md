...
- `GarageCover/` - localhost-only opaque streamer privacy browser source with settings-tab image preview/test controls, app-owned imported cover images, black TMR fallback, and fail-closed Garage/setup-screen detection
