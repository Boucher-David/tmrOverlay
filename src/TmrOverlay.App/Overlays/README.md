...
- `StreamChat/` - browser-source settings/localhost route for one selected chat source at a time: Streamlabs Chat Box widget URL or public Twitch channel chat; not a native WinForms overlay yet
