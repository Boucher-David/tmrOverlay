...
- `CarRadar/` - transparent circular proximity radar from fresh live `CarLeftRight`, `CarIdxF2Time`, `CarIdxEstTime`, and `CarIdx*` progress arrays, with car rectangles coloring white/yellow/red as traffic gets closer
