...
internal sealed class HistoricalSessionAccumulator
{
    ...
    private HistoricalConditions BuildConditions()
    {
        ...
        return new HistoricalConditions
        {
            ...
            TrackTempC = latestSample?.TrackTempC,
            ...
            Skies = latestSample?.Skies,
            WindVelMetersPerSecond = latestSample?.WindVelMetersPerSecond,
            WindDirRadians = latestSample?.WindDirRadians,
            RelativeHumidityPercent = latestSample?.RelativeHumidityPercent,
            FogLevelPercent = latestSample?.FogLevelPercent,
            PrecipitationPercent = latestSample?.PrecipitationPercent,
            AirDensityKgPerCubicMeter = latestSample?.AirDensityKgPerCubicMeter,
            AirPressurePa = latestSample?.AirPressurePa,
            SolarAltitudeRadians = latestSample?.SolarAltitudeRadians,
            SolarAzimuthRadians = latestSample?.SolarAzimuthRadians,
            ...
            SessionTrackSurfaceTempC = _context.Conditions.TrackSurfaceTempC,
            SessionTrackSurfaceTempCrewC = _context.Conditions.TrackSurfaceTempCrewC,
            SessionTrackAirTempC = _context.Conditions.TrackAirTempC,
            SessionTrackAirPressure = _context.Conditions.TrackAirPressure,
            SessionTrackAirDensityKgPerCubicMeter = _context.Conditions.TrackAirDensityKgPerCubicMeter,
            SessionTrackWindVelMetersPerSecond = _context.Conditions.TrackWindVelMetersPerSecond,
            SessionTrackWindDirRadians = _context.Conditions.TrackWindDirRadians,
            SessionTrackRelativeHumidityPercent = _context.Conditions.TrackRelativeHumidityPercent,
            SessionTrackFogLevelPercent = _context.Conditions.TrackFogLevelPercent,
